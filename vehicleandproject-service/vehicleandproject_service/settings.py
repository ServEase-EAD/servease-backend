"""
Django settings for vehicleandproject_service project.
...
ROOT_URLCONF = 'vehicleandproject_service.urls'
...
WSGI_APPLICATION = 'vehicleandproject_service.wsgi.application'
...
# CORS Configuration - using specific allowed origins to avoid duplication
CORS_ALLOW_ALL_ORIGINS = False
CORS_ALLOWED_ORIGINS = [
    'http://localhost:5173',
    'http://localhost:3000',
