...
SECRET_KEY = config(
    'SECRET_KEY', default='django-insecure-lh$tze7e%4ld@m6py#^@rx0u572j^l0xfkgwbk6+i-je*^^-+1')
...
MIDDLEWARE = [
    ...
    # CSRF disabled for REST API - using JWT authentication instead
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': [
        ...
        # Removed SessionAuthentication to disable CSRF checks
...
# Custom user ID field for JWT authentication (links to auth service)
