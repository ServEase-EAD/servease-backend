...
from .serializers import EmployeeSerializer, AssignedTaskSerializer
...
class AssignedTasksViewSet(viewsets.ViewSet):
    ...
    def list(self, request):
        try:
            # Get the employee's ID from the authenticated user
            employee_id = request.user.id

            # Make a request to the appointment service to get assigned tasks
            ...
            # Get customer and vehicle details for each appointment
